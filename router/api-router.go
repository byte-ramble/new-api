...
func SetApiRouter(router *gin.Engine) {
	...
	apiRouter.Use(middleware.GlobalAPIRateLimit())
	{
		...
		channelRoute.Use(middleware.AdminAuth())
		{
			...
			channelRoute.POST("/claude_code/oauth/start", controller.StartClaudeCodeOAuth)
			channelRoute.POST("/claude_code/oauth/complete", controller.CompleteClaudeCodeOAuth)
			channelRoute.POST("/:id/claude_code/oauth/start", controller.StartClaudeCodeOAuthForChannel)
			channelRoute.POST("/:id/claude_code/oauth/complete", controller.CompleteClaudeCodeOAuthForChannel)
			channelRoute.POST("/:id/claude_code/refresh", controller.RefreshClaudeCodeChannelCredentialController)
