...
| [operations/affiliate-program.md](operations/affiliate-program.md) | 多级邀请返佣（数据模型 / 算法 / 风控 / 上线 checklist） | `model/{affiliate_account,commission_log,withdrawal}.go`, `service/affiliate.go`, `setting/.../affiliate_setting.go` |
